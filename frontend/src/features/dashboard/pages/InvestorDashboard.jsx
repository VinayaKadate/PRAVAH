...
import { MONTHLY, REGION_SPLIT, PIE_COLORS, SECTOR_INVEST } from "../../../constants/mockData";
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={MONTHLY} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                  ...
                  <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 11, fill: C.slate }} tickFormatter={(v) => v / 1000 + "k"} />
                  <Tooltip
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className={panel} style={ps}>
              ...
              <div className="h-44">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie data={REGION_SPLIT} cx="50%" cy="50%" innerRadius={35} outerRadius={60} paddingAngle={2} dataKey="value" stroke="none">
            ...
            <div className={panel} style={ps}>
              ...
              <div className="h-56">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={SECTOR_INVEST} layout="vertical" margin={{ top: 0, right: 0, left: 0, bottom: 0 }}>
